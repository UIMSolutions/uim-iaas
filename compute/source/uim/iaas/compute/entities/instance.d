...
class InstanceEntity : IaasEntity {
  ...
  @property void flavor(string value) {
    _flavor = value;
  }
  ...
  @property void imageId(string value) {
    _imageId = value;
  }
  ...
  @property void networkIds(string[] value) {
    _networkIds = value;
  }
  ...
  @property string[] volumeIds() {
    return _volumeIds;
  }

  @property void volumeIds(string[] value) {
    _volumeIds = value;
  }
  ...
  override Json toJson() {
    return super.toJson().update([
      ...
      "type": _type.toJson,
      "flavor": _flavor.toJson,
      "status": _status.toJson,
      "imageId": _imageId.toJson,
      "networkIds": _networkIds.toJson,
      "volumeIds": _volumeIds.toJson,
    ]);
  }
}
