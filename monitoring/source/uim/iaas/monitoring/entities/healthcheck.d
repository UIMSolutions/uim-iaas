...
class HealthCheckEntity : UIMEntity {
    this() {
        super();
    }
    
    protected string _service;
    @property string service() { return _service; }
    @property void service(string value) { _service = value; }
    ...
    @property long responseTime() { return _responseTime; }
    @property void responseTime(long value) { _responseTime = value; }
